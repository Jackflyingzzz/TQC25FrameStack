...
nb_actuations = 105 # Number of actions (NN actuations) taken per episode (Number of action intervals)
...
def resume_env(plot=False,  # To plot results (Field, controls, lift, drag, rec area) during training
    ...
    def _init():
        ...
        simulation_duration = 60.0  # duree en secondes de la simulation #50.0 default
        dt = 0.004
        single_input = False
        single_output = False
